...
const VARIABLE_TAGS = [
    ...
    { tag: '{{dob}}', description: 'Employee Date of Birth' },
    { tag: '{{gender}}', description: 'Employee Gender' },
    { tag: '{{marital_status}}', description: 'Employee Marital Status' },
    { tag: '{{alt_contact}}', description: 'Alternate Contact Number' },
